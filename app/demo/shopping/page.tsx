  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center px-4 text-center">
      <div className="relative mb-8">
        ...
        <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-white shadow-xl shadow-blue-500/10 ring-1 ring-slate-900/5 dark:bg-slate-900 dark:shadow-blue-500/20 dark:ring-white/10">
      ...
      <p className="mx-auto mb-10 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
        We are crafting the ultimate Shopping Demo App for QA engineers. 
        Soon, you'll be able to practice cart flows, product exploration, and complex checkout automations!
      </p>
