...
export default function BankDemoLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!isReady) {
    ...
    return <div className={styles.loginWrapper} data-testid="demo-bank-layout" data-section="demo-bank">Loading secure banking portal...</div>;
  }
  ...
  return (
    <div className={styles.layoutContainer} data-testid="demo-bank-layout" data-section="demo-bank">
      {/* Sidebar */}
      <aside className={styles.sidebar}>
        ...
        <Link 
          ...
          className={`${styles.sidebarLink} ${pathname === '/demo/bank/dashboard' ? styles.sidebarLinkActive : ''}`}
