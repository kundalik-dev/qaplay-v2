...
const SECONDARY_NAV = [
  { label: 'Profile',  href: '/demo/bank/dashboard', icon: <IconProfile />,  testid: 'sidebar-link-profile' },
  { label: 'Settings', href: '/demo/bank/dashboard', icon: <IconSettings />, testid: 'sidebar-link-settings' },
];

/* ── Layout ─────────────────────────────────────────────────────── */
export default function BankDemoLayout({ children }: { children: React.ReactNode }) {
  const { version, setVersionAndData, isLoggedIn, logout, user } = useBankStore();
  ...
  useEffect(() => {
    if (isReady) {
      ...
      } else if (isLoggedIn && (pathname === '/demo/bank/login' || pathname === '/demo/bank')) {
  ...
  if (!isReady) {
    return (
      <div className="bank-loading" data-testid="demo-bank-layout" data-section="demo-bank">
  ...
  return (
    <div className="bank-page" data-testid="demo-bank-layout" data-section="demo-bank">

      {/* ── Top Bar ───────────────────────────────────────────── */}
      <header className="bank-topbar" data-testid="bank-topbar">
        <a href="/demo/bank/dashboard" className="bank-topbar-brand" data-testid="bank-brand-link">
        ...
        <div className="bank-topbar-right">
          <div className="bank-topbar-user" data-testid="bank-topbar-user">
            <div className="bank-topbar-avatar" aria-hidden="true">{initials}</div>
      ...
      <div className="bank-body">
        ...
        {/* Left Sidebar */}
        <aside className="bank-sidebar" data-testid="bank-sidebar" role="navigation" aria-label="Main navigation">
