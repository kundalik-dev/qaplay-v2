...
const data = (id: string) =>
  ALERT_CARDS_DATA.find((c: CardData) => c.id === id)!;
...
export function PromptCard({ index }: { index: number }) {
  ...
  const handlePrompt = () => {
    ...
    if (name === null) setResult("You dismissed the prompt (returned null).");
      ...
      setResult("Hello, anonymous! (empty string submitted)");
  ...
  return (
    <BaseCard id="beforeunload" index={index} testId="block-beforeunload">
      <div className="form-field">
        <label className="form-label" htmlFor="draft-input">
...
export function ChainedDialogsCard({ index }: { index: number }) {
  ...
  const runChain = () => {
    ...
    if (!proceed) {
      setResult("Checkout cancelled at payment step.");
      return;
    }
    const coupon = prompt(
...
export function DynamicOtpCard({ index }: { index: number }) {
  ...
  const verifyOtp = () => {
    ...
    setResult(
      ok ? `Verified! (code ${otp})` : `Verification failed (expected ${otp}).`,
    );
  };
  ...
  return (
    <BaseCard id="nonclick-triggers" index={index} testId="block-nonclick">
      ...
      <div className="form-field" style={{ marginTop: 14 }}>
        <label className="form-label" htmlFor="blur-input">
          ...
          <div className={styles.modalActions}>
            <button
              ...
              onClick={() => {
                ...
                setResult("Second modal confirmed");
              }}
            >
              Confirm
            </button>
          ...
          <div className={styles.modalActions}>
            <button
              ...
              onClick={() => {
                ...
                setResult("Acknowledged via button");
              }}
            >
              Acknowledge
            </button>
        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Click via <code>frameLocator</code>, catch at <code>page</code>{" "}
                level
              </td>
            </tr>
            <tr>
