...
export default function SendMoneyConfirmationPage() {
  ...
  return (
    <div
      ...
      data-testid="send-money-confirmation-page"
      data-section="send-confirmation"
    >
      <div
      ...
      <div
        ...
        data-testid="send-confirmation-summary"
      >
        ...
        <div className="space-y-2 text-sm">
          {[
            ...
            ...(note
              ? [{ label: "Note", value: note, testid: "confirm-note" }]
              : []),
