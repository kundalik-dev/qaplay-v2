...
const PrivacyPolicy = () => {
  return (
    <main className="prose prose-slate dark:prose-invert max-w-none text-gray-800 dark:text-gray-200">
      ...
      <p className="mb-4">
        Welcome to <strong>{basicDetails.websiteName}</strong>{" "}
        (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;, or &ldquo;the
        Platform&rdquo;), accessible at{" "}
        <Link
        ...
        we use it, and your rights regarding that information. By using the
      ...
      <ul className="mb-4 list-disc space-y-1 pl-5">
        <li>
          <strong>Account registration:</strong> Name and email address when you
          create an account.
        </li>
        <li>
          <strong>Contact enquiries:</strong> Name, email address, and message
          content when you contact us via the contact form or email.
        </li>
        <li>
          <strong>Study Tracker &amp; Resources:</strong> Learning progress
          data, syllabus preferences, and saved resources you choose to store in
          the Platform.
        </li>
      </ul>
      ...
      <ul className="mb-4 list-disc space-y-1 pl-5">
        <li>
          ...
          operating system, referring URL, pages visited, and time/date of your
          visit.
        </li>
        <li>
          <strong>Device information:</strong> Device type, screen resolution,
        ...
        <li>
          <strong>Usage data:</strong> Interactions with practice elements,
          features used, and session duration, collected via Google Analytics.
        </li>
      </ul>
      ...
      <ul className="mb-4 list-disc space-y-1 pl-5">
        ...
        <li>
          To analyse usage patterns and improve user experience via Google
          Analytics.
        </li>
        <li>To display relevant advertisements through Google AdSense.</li>
        <li>
          To send you important service-related communications (not marketing,
          unless you opt in).
        </li>
      ...
      <p className="mb-3">
        ...
        experience, analyse traffic, and serve advertisements. Cookies are small
      ...
      <ul className="mb-4 list-disc space-y-2 pl-5">
        <li>
          ...
          to function (e.g., session authentication via Better-Auth). These
          cannot be disabled.
        </li>
        <li>
          <strong>Functional / Preference Cookies:</strong> Store your
          preferences such as dark/light mode and Study Tracker settings (stored
          in localStorage).
        </li>
        <li>
          <strong>Analytics Cookies:</strong> Used by Google Analytics (see
          Section 4) to collect anonymous usage data. These help us understand
          how visitors use the Platform.
        </li>
        <li>
          <strong>Advertising Cookies:</strong> Used by Google AdSense and its
          partners (including the DoubleClick cookie) to serve personalised
          advertisements based on your browsing history on this and other
          websites (see Section 5).
        </li>
      </ul>

      <h3 className="mt-4 mb-2 text-lg font-semibold">Managing Cookies</h3>
      <p className="mb-4">
        You can control and delete cookies through your browser settings. Note
        that disabling cookies may affect the functionality of certain parts of
        the Platform. For more information, visit{" "}
        <Link
      ...
      {/* 4. Google Analytics */}
      <h2 className="mt-8 mb-3 text-2xl font-semibold">4. Google Analytics</h2>
      <p className="mb-4">
        We use <strong>Google Analytics</strong> (tracking ID:{" "}
        <code>G-Z4H9RTYGS4</code>) to analyse how visitors interact with the
        Platform. Google Analytics collects data such as pages visited, time
        spent, and general geographic location. This data is aggregated and
        anonymised — we cannot identify you personally from it.
      </p>
      <p className="mb-4">
        Google Analytics uses cookies to collect this information. You can opt
      ...
      <p className="mb-4">
        We use <strong>Google AdSense</strong> to display advertisements on the
        Platform. Google AdSense is an advertising service provided by Google
        LLC. Third-party vendors, including Google, use cookies to serve ads
        based on your prior visits to this website and other websites across the
        internet.
      </p>
      <p className="mb-4">
        Google uses the <strong>DoubleClick cookie</strong> and other tracking
        technologies to serve ads based on your interests. These cookies allow
        Google and its partners to serve personalised ads to you when you visit
        our Platform and other websites.
      </p>
      <ul className="mb-4 list-disc space-y-1 pl-5">
        <li>
          We do not control the cookies placed by Google or its advertising
          partners.
        </li>
        <li>
          Google may share data collected via AdSense with other Google
          services.
        </li>
        <li>
      ...
      <p className="mb-4">
        You can opt out of personalised advertising served by Google and its
      ...
      <p className="mb-4">
        Opting out of personalised ads does not mean you will stop seeing ads —
      ...
      <ul className="mb-4 list-disc space-y-1 pl-5">
        <li>
          <strong>Service providers:</strong> Third-party vendors that help
          operate the Platform, such as Vercel (hosting), Neon/Supabase
          (database hosting), Google Analytics, and Google AdSense. These
          providers are bound by contractual obligations to keep your
          information confidential.
        </li>
        <li>
          <strong>Legal obligations:</strong> If required by law, court order,
        ...
        <li>
          ...
          Service, protect our rights, or prevent fraud or illegal activity.
        </li>
      </ul>
      ...
      <h3 className="mt-4 mb-2 text-lg font-semibold">All Users</h3>
      <ul className="mb-4 list-disc space-y-1 pl-5">
      ...
      <h3 className="mt-4 mb-2 text-lg font-semibold">EU / EEA Users (GDPR)</h3>
      <ul className="mb-4 list-disc space-y-1 pl-5">
        <li>Right of access (Article 15 GDPR).</li>
        <li>Right to rectification (Article 16 GDPR).</li>
        <li>
          Right to erasure / &ldquo;right to be forgotten&rdquo; (Article 17
          GDPR).
        </li>
      ...
      {/* 8. Data Retention */}
      <h2 className="mt-8 mb-3 text-2xl font-semibold">8. Data Retention</h2>
      <ul className="mb-4 list-disc space-y-1 pl-5">
        <li>
          <strong>Account data:</strong> Retained for as long as your account is
          active. You may delete your account at any time by contacting us.
        </li>
        <li>
          <strong>Session data:</strong> Authentication sessions expire after 7
          days of inactivity.
        </li>
        <li>
          <strong>Analytics data:</strong> Google Analytics retains data for 26
          months by default.
        </li>
        <li>
          <strong>Contact enquiries:</strong> Retained for up to 12 months to
          allow us to follow up on your request.
        </li>
        <li>
          <strong>LocalStorage data:</strong> Stored in your browser until you
          clear your browser data or uninstall the browser.
        </li>
      </ul>

      {/* 9. Data Security */}
      <h2 className="mt-8 mb-3 text-2xl font-semibold">9. Data Security</h2>
      <p className="mb-4">
        ...
        or destruction. These include encrypted database connections, secure
        HTTPS transmission, and session-based authentication via Better-Auth.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        The Platform may contain links to external websites (e.g., blog
        references, tutorial resources, GitHub). We are not responsible for the
        privacy practices of those sites. We encourage you to review the privacy
      ...
      <p className="mb-4">
        ...
        we do, we will update the &ldquo;Last Updated&rdquo; date at the top of
      ...
      <section className="not-prose mt-12 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-950">
        <div className="border-b border-slate-200 bg-slate-50 px-6 py-6 sm:px-8 dark:border-slate-800 dark:bg-slate-900/70">
          <p className="mb-2 text-sm font-semibold tracking-wide text-rose-600 uppercase dark:text-rose-400">
            13. Contact Us
          </p>
          ...
          <p className="mt-3 max-w-3xl text-base leading-7 text-slate-600 dark:text-slate-300">
            ...
            Privacy Policy or your personal data, choose the best way to reach
            us below.
          </p>
        </div>
        ...
        <div className="grid gap-4 p-6 sm:grid-cols-3 sm:p-8">
          ...
          >
            ...
            <span className="mt-2 block text-sm leading-6 break-words text-slate-600 dark:text-slate-300">
              {basicDetails.websiteEmail}
            </span>
          </Link>
