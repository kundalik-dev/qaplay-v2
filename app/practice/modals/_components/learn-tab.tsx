...
import {
  ...
  modalsFaq,
  modalsTocItems,
} from "@/data/practice-data/modals/learn";
    ...
    <div className="mx-auto w-full max-w-[1280px] px-4 py-6 pb-16 sm:px-7 sm:py-8">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_200px] lg:gap-12">
        <main aria-label="Learn content" className="flex flex-col gap-5">
          ...
          <DocSection
            id="learn-locating"
            heading="1 · Locating Modals"
            desc={modalsLearnDesc.locating}
          >
            <LearnCodeBlock snippets={locating} />
          </DocSection>

          <DocSection
            id="learn-interacting"
            heading="2 · Interacting Inside Modals"
            desc={modalsLearnDesc.interacting}
          >
