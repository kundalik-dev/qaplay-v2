    ...
    <div className="mx-auto w-full max-w-[1280px] px-4 py-6 pb-16 sm:px-7 sm:py-8">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_200px] lg:gap-12">
        <main aria-label="Learn content" className="flex flex-col gap-5">
          ...
          <DocSection
            id="learn-checkbox"
            heading="1 · Check / Uncheck"
            desc={radioCheckboxLearnDesc.checkbox}
          >
          ...
          <DocSection
            id="learn-radio"
            heading="2 · Radio Groups"
            desc={radioCheckboxLearnDesc.radio}
          >
          ...
          <DocSection
            id="learn-assert"
            heading="3 · Assert State"
            desc={radioCheckboxLearnDesc.assert}
          >
          ...
          <DocSection
            id="learn-disabled"
            heading="4 · Disabled Controls"
            desc={radioCheckboxLearnDesc.disabled}
          >
