    ...
    <div className="mx-auto w-full max-w-[1280px] px-4 py-6 pb-16 sm:px-7 sm:py-8">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_200px] lg:gap-12">
        <main aria-label="Learn content" className="flex flex-col gap-5">
          ...
          <DocSection
            id="learn-basic"
            heading="1 · frameLocator basics"
            desc={iframesLearnDesc.basic}
          >
          ...
          <DocSection
            id="learn-nested"
            heading="2 · Nested iframes"
            desc={iframesLearnDesc.nested}
          >
          ...
          <DocSection
            id="learn-locate"
            heading="3 · Locate by name & title"
            desc={iframesLearnDesc.locate}
          >
          ...
          <DocSection
            id="learn-dynamic"
            heading="4 · Dynamic iframe content"
            desc={iframesLearnDesc.dynamic}
          >
