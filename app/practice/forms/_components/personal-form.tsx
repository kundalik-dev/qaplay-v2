...
const RADIOS = [
  {
    id: "gender-male",
    testId: "radio-gender-male",
    value: "male",
    label: "Male",
  },
  {
    id: "gender-female",
    testId: "radio-gender-female",
    value: "female",
    label: "Female",
  },
  {
    id: "gender-other",
    testId: "radio-gender-other",
    value: "other",
    label: "Other",
  },
] as const;
...
export function PersonalDetailsForm() {
  ...
  return (
    <FormCard
      ...
      level="Beginner"
      hint={HINT}
      testId="form-personal"
    >
      <form
        data-testid="form-personal-inner"
      ...
      >
        ...
        <div className={styles.fieldRow}>
          <span id="gender-group-label" className={styles.label}>
