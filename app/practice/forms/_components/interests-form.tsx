...
const ITEMS = [
  {
    id: "interest-selenium",
    testId: "checkbox-interest-selenium",
    value: "selenium",
    label: "Selenium",
  },
  {
    id: "interest-playwright",
    testId: "checkbox-interest-playwright",
    value: "playwright",
    label: "Playwright",
  },
  {
    id: "interest-cypress",
    testId: "checkbox-interest-cypress",
    value: "cypress",
    label: "Cypress",
  },
  {
    id: "interest-appium",
    testId: "checkbox-interest-appium",
    value: "appium",
    label: "Appium",
  },
  {
    id: "interest-jest",
    testId: "checkbox-interest-jest",
    value: "jest",
    label: "Jest",
  },
];
...
export function InterestsForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    setError("");
    const labels = ITEMS.filter((i) => selected.includes(i.value)).map(
      (i) => i.label,
    );
  ...
  return (
    <FormCard
      ...
      level="Medium"
      hint={HINT}
      testId="form-interests"
    >
      <form
        data-testid="form-interests-inner"
