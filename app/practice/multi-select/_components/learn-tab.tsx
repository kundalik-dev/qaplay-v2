    ...
    <div className="mx-auto w-full max-w-[1280px] px-4 py-6 pb-16 sm:px-7 sm:py-8">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_200px] lg:gap-12">
        <main aria-label="Learn content" className="flex flex-col gap-5">
          ...
          <DocSection
            id="learn-native"
            heading="1 · Native selectOption"
            desc={multiSelectLearnDesc.native}
          >
          ...
          <DocSection
            id="learn-custom"
            heading="2 · Custom Checkbox Dropdown"
            desc={multiSelectLearnDesc.custom}
          >
          ...
          <DocSection
            id="learn-tags"
            heading="3 · Tag / Pill Removal"
            desc={multiSelectLearnDesc.tags}
          >
          ...
          <DocSection
            id="learn-searchable"
            heading="4 · Searchable Multi-Select"
            desc={multiSelectLearnDesc.searchable}
          >
