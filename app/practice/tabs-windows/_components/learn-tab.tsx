    ...
    <div className="mx-auto w-full max-w-[1280px] px-4 py-6 pb-16 sm:px-7 sm:py-8">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_200px] lg:gap-12">
        <main aria-label="Learn content" className="flex flex-col gap-5">
          ...
          <DocSection
            id="learn-new-tab"
            heading="1 · Open & Capture New Tab"
            desc={tabsWindowsLearnDesc.newTab}
          >
          ...
          <DocSection
            id="learn-switch"
            heading="2 · Switch & Return"
            desc={tabsWindowsLearnDesc.switch}
          >
          ...
          <DocSection
            id="learn-popup"
            heading="3 · Popups (window.open)"
            desc={tabsWindowsLearnDesc.popup}
          >
          ...
          <DocSection
            id="learn-close"
            heading="4 · Close a Tab"
            desc={tabsWindowsLearnDesc.close}
          >
