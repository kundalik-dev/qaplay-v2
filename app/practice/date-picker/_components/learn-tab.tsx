    ...
    <div className="mx-auto w-full max-w-[1280px] px-4 py-6 pb-16 sm:px-7 sm:py-8">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_200px] lg:gap-12">
        <main aria-label="Learn content" className="flex flex-col gap-5">
          ...
          <DocSection id="learn-native" heading="1 · Native Date Input" desc={datePickerLearnDesc.native}>
            <LearnCodeBlock snippets={native} />
          </DocSection>

          <DocSection id="learn-calendar" heading="2 · Calendar Widget" desc={datePickerLearnDesc.calendar}>
            <LearnCodeBlock snippets={calendar} />
          </DocSection>

          <DocSection id="learn-range" heading="3 · Date Range" desc={datePickerLearnDesc.range}>
            <LearnCodeBlock snippets={range} />
          </DocSection>

          <DocSection id="learn-constraints" heading="4 · Min / Max Constraints" desc={datePickerLearnDesc.constraints}>
