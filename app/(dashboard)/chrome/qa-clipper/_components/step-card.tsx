  ...
  return (
    <article className="capture-card h-full p-6">
      <div className="flex items-start gap-4">
        <div
          className={`${toneClasses.bg} ${toneClasses.border} ${toneClasses.text} flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border font-mono text-xs font-bold tracking-[0.18em]`}
        >
          {step}
        </div>
