...
const description = "Practice interacting with, asserting, and closing modal dialogs and overlays in your test suites.";

export const modalsPageWebPageJsonLd = createWebPageJsonLd({
  name,
  description,
  path: "/practice/modals",
  about: ["Modal window automation", "Selenium modals", "Playwright dialogs", "Cypress modals"],
  mainEntity: {
    "@type": "Thing",
