...
const description = "Learn how to automate link clicks, verify URLs, handle new tabs, and find links by text using Selenium WebDriver, Playwright, and Cypress.";

export const linksPageWebPageJsonLd = createWebPageJsonLd({
  name,
  description,
  path: "/practice/links",
  about: ["Link automation", "Selenium links", "Playwright links", "Cypress links"],
  mainEntity: {
    "@type": "Thing",
