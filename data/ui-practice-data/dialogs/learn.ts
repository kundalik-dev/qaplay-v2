...
/**
 * Learn content for /ui-practice/dialog/learn. Ported from
 * data/practice-data/alerts-dialogs/learn.ts (which stays in place for
 * the classic /practice/alerts-dialogs page).
 */
export const dialogsTocItems: TocItem[] = [
...
export const dialogsLearnDesc: Record<string, string> = {
  overview:
...
export const dialogsLearnCode: Record<string, LearnCodeSnippet> = {
  openVerify: {
    pw: {
      lang: "TypeScript",
...
export const dialogsMethodRows: MethodRow[] = [
  {
    action: "Open dialog",
