...
export const iframesTestCases: TestCase[] = [
  {
    ...
    expected: "Input inside the iframe is filled; result text confirms submission.",
    type: "positive",
    priority: "high",
    steps: [
  ...
  },
  {
    ...
    expected: "Same form interacted with; frameLocator by title resolves correctly.",
    type: "positive",
    priority: "medium",
    steps: [
  ...
  },
  {
    ...
    expected: "Same form interacted with; frameLocator by name resolves correctly.",
    type: "positive",
    priority: "medium",
    steps: [
  ...
  {
    id: "IFR_007",
    scenario: "Locate iframe by name attribute and click button inside (no testid)",
  ...
  },
  {
    ...
    expected: "Inner iframe input filled and submitted; result propagates to page.",
    type: "positive",
    priority: "high",
    steps: [
  ...
  {
    id: "IFR_010",
    scenario: "Switch to parent frame after interacting with nested iframe (Selenium)",
  ...
  },
  {
    ...
    expected: "Button appears after delay; interaction succeeds without timeout error.",
    type: "positive",
    priority: "high",
    steps: [
  ...
  },
  {
    ...
    expected: "Error spans appear; they have no data-testid — located via role or XPath.",
    type: "negative",
    priority: "high",
    steps: [
  ...
  },
  {
    ...
    expected: "Company field filled using getByLabel — no data-testid on that field.",
    type: "positive",
    priority: "medium",
    steps: [
      'Switch into validation iframe.',
